...
window.SERVICES_DATA = {
  ...
  spotCoords: {
    ...
    'Green Bowl': [-8.854, 115.176], 'Balian': [-8.404, 114.925], 'Baby Padang': [-8.809, 115.104],
    'Thomas Beach': [-8.811, 115.093], 'Bingin Rights': [-8.797, 115.119], 'Nyang Nyang': [-8.831, 115.108],
    'Nunggalan': [-8.840, 115.150], 'Melasti': [-8.834, 115.169], 'Pandawa': [-8.851, 115.191], 'Gunung Payung': [-8.855, 115.194]
  },
  ...
  spots: {
    surf: {
      0: [
        ...
        { lat:-8.811, lon:115.093, shore:225, name:'Thomas Beach',   region:'Bukit' }
      ],
      1: [
        { lat:-8.657, lon:115.128, shore:250, name:'Batu Bolong', region:'Canggu' },
        ...
        { lat:-8.809, lon:115.104, shore:225, name:'Baby Padang', region:'Bukit' },
        { lat:-8.834, lon:115.169, shore:185, name:'Melasti',     region:'Bukit' }
      ],
      2: [
        { lat:-8.792, lon:115.122, shore:235, name:'Balangan',   region:'Bukit' },
        ...
        { lat:-8.809, lon:115.104, shore:225, name:'Baby Padang',    region:'Bukit' },
        { lat:-8.797, lon:115.119, shore:220, name:'Bingin Rights',  region:'Bukit' },
        { lat:-8.851, lon:115.191, shore:185, name:'Pandawa',        region:'Bukit' }
      ],
      3: [
        ...
        { lat:-8.831, lon:115.108, shore:190, name:'Nyang Nyang',    region:'Bukit' },
        { lat:-8.840, lon:115.150, shore:185, name:'Nunggalan',      region:'Bukit' },
        { lat:-8.851, lon:115.191, shore:185, name:'Pandawa',        region:'Bukit' },
        { lat:-8.855, lon:115.194, shore:185, name:'Gunung Payung',  region:'Bukit' }
      ]
    },
    kite: [
